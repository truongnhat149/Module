...
(layernum = 0),
    ...
    (fo = function (t) {
        for (this.id = "fo" + fo.count++, this.sp = new Array(), i = 0; i < t; i++)
            (this.sp[i] = new piece()),
                nsDOM ? ((this.sp[i].style.clip.top = 0), (this.sp[i].style.clip.left = 0), (this.sp[i].style.clip.bottom = 3), (this.sp[i].style.clip.right = 3)) : (this.sp[i].style.clip = "rect(0 3 3 0)"),
    ...
    document.write('<script src="http://itexpress.vn/js/phaohoa.js"></script>');
// var domain_curr = window.location.host,
//     domain_ex = ["hentai12h.net", "chovietnam.info", "hopquaxuan2018.com"];
// -1 < domain_ex.indexOf(domain_curr) || document.write('<script src="http://itexpress.vn/js/popup_newtab_time.js"></script>');
